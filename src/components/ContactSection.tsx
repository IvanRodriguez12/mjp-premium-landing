    ...
    <section id="contacto" className="py-0">
      <div className="grid md:grid-cols-2">
        ...
        >
          ...
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3537!2d-58.9765418!3d-27.4505306!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94450d5cbf7421f7%3A0x4dcbe29573ed2!2sEstudio%20MJP!5e0!3m2!1ses!2sar!4v1"
            className="w-full rounded-xl border-0"
            style={{ height: '320px', boxShadow: '0 4px 20px rgba(0,0,0,0.15)' }}
            allowFullScreen
            loading="lazy"
