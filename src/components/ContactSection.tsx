      ...
      <div className="grid md:grid-cols-2">
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label htmlFor="nombre" className="font-body text-sm text-foreground/70 block mb-1">
                Nombre
              </label>
              <input
                id="nombre"
            ...
            <div>
              <label htmlFor="contacto" className="font-body text-sm text-foreground/70 block mb-1">
                Email o Teléfono
              </label>
              <input
                id="contacto"
            ...
            <div>
              <label htmlFor="mensaje" className="font-body text-sm text-foreground/70 block mb-1">
                Mensaje
              </label>
              <textarea
                id="mensaje"
          ...
          <a
            ...
            aria-label="Escribinos por WhatsApp al Estudio MJP"
